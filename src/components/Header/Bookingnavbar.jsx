    ...
    return (
        <div className=" bg-purple-600">
            <div className="w-full navbar">
                <ul className="menu menu-horizontal container mx-auto lg:px-60 ">
                    <li>
            ...
            <div className="container mx-auto lg:px-60 text-white lg:relative py-10">
                <div>
                ...
                <div className="lg:absolute -bottom-8 bg-yellow-500 rounded-lg">
                    <div className="lg:h-16 lg:grid grid-cols-4 gap-4 justify-center items-center">
                        <div className="bg-white p-3 mb-2 lg:mb-0 rounded-lg lg:mx-2">
                        ...
                        <div className="bg-white p-3 mb-2 lg:mb-0 rounded-lg">
                            <div className="flex gap-2">
                                ...
                                <div className="dropdown">
                                    <span className="text-gray-400" tabIndex={0} role="button">2 audlts, 1 children, 1 room</span>
                                        ...
                                        <div className="bg-white p-4">
                                            <div className="flex justify-between items-center mb-4">
                                                ...
                                                <div className="flex justify-between items-center gap-4 border border-gray-600 rounded p-2">
                                                    <button className="btn btn-sm btn-ghost"><FiMinus /></button>
                                                    <span className="text-gray-600">1</span>
                                                    <button className="btn btn-sm btn-ghost"><FiPlus /></button>
                                                </div>
                                            </div>
                                            <div className="flex justify-between items-center mb-4">
                                                <span>Children</span>
